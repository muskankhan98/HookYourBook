		...
		<div class="navbar">
			...
			<li><a href="#" class="link">Services</a>
					<ul>
						...
						<li><a href ="#" class="link"> Complain</a></li>
					</ul>
			</li>
...
<h2>Send Complain to admin:</h2>
<div class="container">
<form action="complain_code.jsp" enctype="text/plain">
Name:<br>
<input type="text" name="name"><br>
E-mail:<br>
<input type="text" name="mail"><br>
Complain:<br>
<textarea id="discriptiont" name="discription" placeholder="Write your complain here.." style="height:200px"></textarea>
<br><br>
