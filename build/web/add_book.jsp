	...
	<div id="header">
		...
		<div class="navbar">
			...
			<li><a href="#" class="link">Options</a>
					<ul>
						<li><a href ="#" class="link"> Add Book for Swapping</a></li>
...
<div class="container">
  <form action="add_book_code.jsp">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <textarea id="discriptiont" name="discription" placeholder="Write something.." style="height:200px"></textarea>
      </div>
    </div><br>
    <div class="row">
